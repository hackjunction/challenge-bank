...
const EventController = {
  validate: eventData => {
    ...
    const platformOpens = moment.tz(
      eventData.platformOpens,
      eventData.timezone
    );
    const platformCloses = moment.tz(
      eventData.platformCloses,
      eventData.timezone
    );
    ...
    if (platformOpens.isBefore(startTime)) {
      return Promise.reject(
        "Challenge platform cannot open before the event starts"
      );
    }

    if (platformCloses.isAfter(endTime)) {
      return Promise.reject(
        "Challenge platform must close before the event ends"
      );
    }
  ...
  deleteEvent: id => {
    return mongoose
      ...
      .catch(error => {
        console.log("ERROR", error);
        throw new Error(
          "An unexpected error occurred while deleting the event, please try again later"
        );
      });
  },
  ...
  getEvents: () => {
    return mongoose
      ...
      .catch(error => {
        console.log("ERROR", error);
        throw new Error(
          "An unexpected error occurred while getting events, please try again later"
        );
      });
  },
  ...
  getEvent: id => {
    return mongoose
      ...
      .catch(error => {
        console.log("ERROR", error);
        throw new Error(
          "An unexpected error occurred while getting the event, please try again later"
        );
      });
  },
