...
const mapDispatch = dispatch => ({
  setSelectedCategories: items =>
    dispatch(FilterActions.setSelectedCategories(items)),
  setSelectedDifficulties: items =>
    dispatch(FilterActions.setSelectedDifficulties(items)),
  clearFilters: () => dispatch(FilterActions.clearFilters())
});

export default connect(mapState, mapDispatch)(ChallengeGridFilters);
