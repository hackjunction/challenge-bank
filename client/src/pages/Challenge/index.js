...
const ChallengePage = ({ challenge, createSubmission, challengeId }) => {
  ...
  return (
    <CenteredContainer>
      ...
      <Divider size={5} />
      <RelatedChallenges
        category={challenge.category.contentful_id}
...
const mapDispatch = (dispatch, ownProps) => ({
  createSubmission: answer =>
    dispatch(
      SubmissionsActions.createSubmission(ownProps.match.params.id, answer)
    )
});

export default connect(mapState, mapDispatch)(ChallengePage);
